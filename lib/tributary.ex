  ...
  defmacro __using__(_) do
    quote do
      ...
      def stream(query, opts \\ []) do
        {trib_opts, repo_opts} = Keyword.split(opts, [:initial_key, :key_name, :chunk_size, :repo_module])
        ...
        repo_module = Keyword.get(trib_opts, :repo_module, __ENV__.module)
